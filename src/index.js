...
function Footer() {
	...
	return (
		<footer className="footer">
			{isOpen ? <Order closeHour={closeHour} openHour={openHour} /> : `Sorry we're closed. We will reopen tomorrow at ${openHour}:00.`}
		</footer>
	);
}
...
function Order({ closeHour, openHour }) {
	return (
		<div className="order">
			We're open from {openHour}:00 to {closeHour}:00. Come on in, or order online!
